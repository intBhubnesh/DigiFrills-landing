...
export default function LoadingScreen() {
    ...
    if (circlesRef.current && isLoading) {
      ...
      for (let i = 0; i < circleCount; i++) {
        ...
        circle.style.transition = `transform ${
          Math.random() * 3 + 2
        }s ease-out, opacity ${Math.random() * 2 + 1}s ease-out`;
  ...
  const cleanupTimers = () => {
    ...
    if (checkFillIntervalRef.current)
      clearInterval(checkFillIntervalRef.current);
      ...
      >
        ...
        >
          <div className="text-white text-7xl md:text-8xl font-bold relative">
            ...
            {/* Animated underline - This is your main progress indicator */}
            <div
