  ...
  return (
    <section className="relative bg-[#F5F6F8]  m-3 lg:m-12 rounded-[40px] p-3">
      <div className="max-w-7xl  flex flex-col lg:flex-row justify-between items-center ">
        ...
        {/* Form Card */}
        <div className="bg-black text-white rounded-[40px] py-8 px-6 md:px-10 -mt-72 md:mt-0 w-full max-w-[96%] shadow-xl  lg:-ml-12 z-10">
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-[#0260EB] text-white font-semibold py-3 rounded-full hover:bg-opacity-90 transition"
            >
              Submit
            </button>
          </form>
