...
const QuoteSection = () => {
  return (
    <section className="relative bg-[#F5F6F8] py-20 px-4 md:px-8">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-12 translate-x-24">
        {/* Orange Card */}
        ...
        {/* Form Card */}
        <div className="bg-black text-white rounded-[40px] py-8 px-6 md:px-10 w-full max-w-lg shadow-xl absolute right-0">
